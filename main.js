...
const fieldMaterial = new THREE.MeshPhongMaterial({ color: 0x408040, side: THREE.DoubleSide });
...
class Disc {
    constructor(radius, height, color, startX, startZ) {
        ...
        this.mesh = new THREE.Mesh(
            ...
            new THREE.MeshPhongMaterial({ color: color, opacity: 0.9, transparent: true })
        );
